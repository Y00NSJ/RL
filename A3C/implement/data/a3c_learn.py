...
class A3Cagent(object):
    ...
    def load_weights(self, path):
        self.global_actor.load_weights(path + 'pendulum_actor.weights.h5')
        self.global_critic.load_weights(path + 'pendulum_critic.weights.h5')
...
class A3Cworker(threading.Thread):
    ...
    def actor_learn(self, states, actions, advantages):
        ...
        with tf.GradientTape() as tape:
            # 정책 확률밀도함수
            mu_a, std_a = self.global_actor(states, training=True)
            ...
            while not done:
                ...
                if done:
                    ...
                    if global_episode_count % 10 == 0:
                        self.global_actor.save_weights("./save_weights/pendulum_actor.weights.h5")
                        self.global_critic.save_weights("./save_weights/pendulum_critic.weights.h5")
